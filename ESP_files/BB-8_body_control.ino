...
BLYNK_WRITE(V0)
{
  dutyCycle = param.asInt(); // assigning incoming value from pin V0 to a variable
  // You can also use:
...
void loop() {
    ...
    // always send data to serial port
    //Serial.print(Ref3);
    //Serial.print("\t");
    //Serial.print(U3);
    //Serial.print("\t");
